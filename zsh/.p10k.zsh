# Generated by Powerlevel10k configuration wizard on 2022-04-27 at 21:31 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND="#abe9b3"
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND="#f28fad"
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND="#6e6c7e"
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND="#6e6c7e"
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND="#6e6c7e"
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND="#6e6c7e"
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND="#f8bd96"
