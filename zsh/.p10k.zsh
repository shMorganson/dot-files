# Generated by Powerlevel10k configuration wizard on 2022-04-22 at 08:49 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND="#ebdbb2"
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND="#282828"
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND="#fe8019"
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND="#ebdbb2"
